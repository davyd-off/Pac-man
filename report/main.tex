...
По коду программы была создана блок-схема %(см. на стр.~\pageref{}).
...
\begin{code}
	...
	\inputminted[mathescape,linenos,frame=lines,breaklines]{Python}{src/button.py}
\end{code}
...
\inputminted[mathescape,linenos,frame=lines,breaklines]{Python}{src/board_1.py}
\end{code}
...
\inputminted[mathescape,linenos,frame=lines,breaklines]{Python}{src/board_2.py}
\end{code}
